                            ...
                            try {
                                ...
                                if (fs.existsSync(interceptorPath + '.js')) {
                                    ...
                                    try {
                                        ...
                                        throw new Error(`Unable to locate Z.AI interceptor. Tried multiple paths:\n1. ${(0, path_1.join)(__dirname, '..', 'interceptors', 'zai-interceptor')}\n2. ${(0, path_1.join)(__dirname, '..', '..', 'src', 'interceptors', 'zai-interceptor')}\n3. ${interceptorPath}\n\nOriginal error: ${e2}`);
                                    }
                                }
                            }
                            catch (e4) {
                                throw new Error(`Unable to locate Z.AI interceptor. Original error: ${e2.message}`);
                            }
                        }
                    }
